  ...
  return (
    <div className="h-auto w-11/12 md:w-10/12 mx-auto flex flex-col md:flex-row justify-center items-center bg-transparent shadow-xl">
      <div className="h-48 md:h-16 w-full bg-white shadow-l rounded-lg md:flex md:flex-row md:justify-between md:items-center">
        <div className="h-12 w-full md:w-[40%] border-b border-gray-300 md:border-0 mb-2 md:mb-0 p-5 py-7 md:py-0 flex flex-row justify-start items-center">
        ...
        <div className="h-auto w-full md:w-[60%] flex flex-col md:flex-row md:px-5 justify-center items-start md:items-center space-y-3 md:space-y-0 md:space-x-4">
